...
export const Dropdown = React.forwardRef(function DropdownRef(
    {
        visible,
        items,
        style,
    ...
    return (
        <DropdownWarpper visible={visible} style={style} onClickOutside={onClickOutside} ref={ref}>
...
export const DropdownWarpper = React.forwardRef(function DropdownWarpperRef(
    props: {
        visible: boolean
        style?: React.CSSProperties
    ...
    React.useEffect(() => {
        ...
        const onClick = (event: MouseEvent) => {
            ...
            if (!menuRect || isInRect(menuRect, event.clientX, event.clientY)) return
